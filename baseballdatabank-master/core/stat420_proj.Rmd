...
The following `R` code loads the `Teams.csv` and `Salaries.csv`. Some data manipulation are performed to get the total salary and the percent of total salary.
