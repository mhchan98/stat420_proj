...
Solving this equaltion in reverse, for the hypothetical average team needs to increase the Run Differential by .133 to .633 to increase their Win Percentage from .500 to .600.  One way this could happen is if the team scored 896 Runs in a season while still holding 682 Runs Allowed, and the same number of Saves, Walks, Complete Games, and Salary Percentage:
